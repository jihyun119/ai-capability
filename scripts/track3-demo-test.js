...
const userMessages = [
  "키키오 선물하기팀에서 다음 분기 3주 동안 진행할 핵심 기능 하나를 선정해야 합니다. 쿠폰함, 위시리스트 공유, 구매 후 추천을 비교할 프레임워크와 회의용 PRD 구조를 잡아주세요.",
  "3주 안에 개발자 2명, 디자이너 1명으로 가능한지를 중요 기준으로 두겠습니다. 세 후보의 임팩트, 리소스 적합성, 리스크를 비교해주세요.",
  "저는 위시리스트 공유 기능에 집중하겠습니다. 선정 근거와 PRD 초안을 목표, 성공지표, 범위, 제외범위, 일정 항목으로 정리해주세요.",
  "방금 초안에서 논리 비약, 빠진 고려사항, 3주 안에 어려운 범위가 없는지 지적해주세요.",
  "그 지적을 반영해서 다음 회의에서 바로 공유할 수 있는 최종 PRD 초안으로 완성해주세요."
];
