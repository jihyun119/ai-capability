...
const t2Questions = [
  {
    ...
    options: [
      "A. 일단 요청해보고 나온 결과물을 보면서 뭘 원하는지 파악하며 다듬는다.",
      "B. 상황과 필요한 정보를 충분히 알려준 뒤 초안을 받고, 주고받으며 완성도를 높인다.",
      "C. 원하는 결과의 조건을 최대한 구체적으로 전달하고, 결과물이 그 조건에 맞는지 직접 따져보며 다듬는다.",
      "D. AI와 대화를 통해 방향과 기준을 충분히 잡은 뒤, 그 틀 안에서 결과물을 만들도록 요청한다.",
      "E. AI 결과를 소재나 표현 참고용으로 활용하되, 내용의 적절성은 스스로 판단해 직접 완성한다.",
    ],
  },
  {
    label: "상황 2",
    ...
    options: [
      "A. AI에게 물어보고 설명해주는 내용을 읽으며 이해해나간다.",
      "B. 알아야 할 범위를 나눠 요청하고, AI가 정리해준 내용을 기반으로 학습한다.",
      "C. 내 상황과 목표에 맞는 학습 방식을 요청하고, 이해가 됐는지 단계마다 확인하며 진행한다.",
      "D. 본격적으로 공부하기 전에 AI와 대화로 무엇을 어떻게 공부해야 할지 먼저 파악한다.",
      "E. AI는 전체 흐름 파악용으로만 쓰고, 실제 학습은 직접 찾은 자료로 한다.",
    ],
  },
  {
    label: "상황 3",
    ...
    options: [
      "A. 기획안을 만들어달라고 요청하고, 나온 결과를 보면서 방향을 잡는다.",
      "B. 배경과 목적을 충분히 설명한 뒤 전체 구조를 잡아달라고 한다.",
      "C. 포함해야 할 요소들을 지정하고, 나온 결과를 보며 부족한 부분을 계속 보완해나간다.",
      "D. AI와 대화로 기획에 필요한 기준과 방향을 먼저 잡고, 그 틀 안에서 내용을 발전시켜나간다.",
      "E. 기획의 뼈대는 직접 잡고, AI에게는 논리적 빈틈이나 개선점을 찾아달라고 한다.",
    ],
  },
  {
    label: "상황 4",
    ...
    options: [
      "A. 마음에 안 든다고 하고 다시 해달라고 한다.",
      "B. 맘에 안 드는 부분을 짚어주고 그 부분을 고쳐달라고 한다.",
      "C. 원하는 결과의 기준을 명확히 다시 전달하고 처음부터 새로 작성하게 한다.",
      "D. 왜 원하는 결과가 안 나왔는지 AI와 함께 원인을 파악하고, 더 나은 방식으로 다시 시도한다.",
      "E. AI 결과는 참고만 하고, 핵심 판단과 구성은 직접 다시 한다.",
    ],
  },
  {
    label: "상황 5",
